...
/* =========================================================
   VELOUR STORY ENGINE V4.4 — APPEARANCE EXPANSION PATCH
...
(() => {
  ...
  function installUI(){
    ...
    p.innerHTML=`
      <div class="v40-title"><b>✦ STORY ENGINE V4.4 · APPEARANCE EXPANDED</b><span class="v40-badge">기존 저장함 호환</span></div>
  ...
  function syncUI(full=true){
    ...
    const s=p.querySelector('#v4Status'); if(s){
      ...
      s.innerHTML=`<b>V4.4 ACTIVE</b> · ${esc(worldLabel())} · ${esc(relationshipLabel())} → ${esc(trajectoryLabel())}<br>`+
...
- 메타는 앱에서 자동 제거되므로 독자에게 설명하지 않는다.`;
  ...
  if(typeof previousBuild==='function'){
    window.buildPrompt=function(isContinue=false){
      ...
      return `${base}\n\n===== VELOUR STORY ENGINE V4.4 · APPEARANCE OVERRIDE =====
...
===== END VELOUR V4.4 =====`;
  ...
  patchDraft();
  console.info('✦ VELOUR Story Engine V4.4 Appearance Expanded loaded');
})();
