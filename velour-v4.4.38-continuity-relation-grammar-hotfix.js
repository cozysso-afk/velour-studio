...
- 친밀 장면을 쓰기 전, 프롬프트에 제공된 최근 본문에서 직전 2~3회의 친밀 장면을 짧게 내부 점검한다: (1) 장소군, (2) 주된 몸의 방향/구도, (3) 대사의 기능과 반복 의미군. 그 다음 최근에 덜 쓴 축을 우선한다.
...
- 대사는 최근 장면의 결과 예고, 결과 요구, 책임 전가형 도발, 범용 욕망 선언 같은 의미군을 자동 후렴구로 반복하지 않는다. 최근 친밀 장면에서 이미 쓴 의미군은 사용자가 직접 요구하지 않는 한 다음 장면에서 우선순위를 크게 낮춘다.
- 대사는 도발/놀림, 욕망 고백, 몸이나 표정에 대한 즉각적 반응, 질문/요구, 속도·거리 조율, 관계 감정 노출, 상대가 방금 한 말에 대한 받아치기 등 여러 기능 중 현재 상황에 필요한 기능을 선택한다. 같은 기능을 여러 문장으로 반복해 분량을 채우지 않는다.
