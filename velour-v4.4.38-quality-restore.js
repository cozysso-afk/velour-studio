...
(() => {
  ...
  function asksExactMeasurements(text){
    return /(?:컵\s*사이즈|몇\s*컵|[A-H]\s*컵|브라\s*사이즈|신체\s*치수|정확한\s*(?:키|치수|사이즈)|몇\s*cm|센티미터)/i.test(String(text || ''));
  }
