...
assert.match(loader,/velour-v4\.4\.38-authoring-experience-v1\.js\?v=1/);

assert.match(index,/velour-v4\.4\.38-vault-accept-hotfix\.js\?v=27/);
assert.match(canonical,/velour-v4\.4\.38-vault-accept-hotfix\.js\?v=27/);
